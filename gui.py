...
class OmniAgentGUI(ctk.CTk):
    def __init__(self, orchestrator, blackboard):
        ...
        self.title("OmniAgent OS - Singularity Prime"); self.geometry("1500x950")
        ...
        self.goal_entry = ctk.CTkEntry(self.header, placeholder_text="Command the Singularity Prime...", width=400, fg_color="#1f2833", border_color="#00ffa3")
        self.goal_entry.pack(side="left", padx=20, pady=15)

        self.run_btn = ctk.CTkButton(self.header, text="TRANSCEND", fg_color="#00ffa3", text_color="#0b0c10", font=("SF Pro Display", 14, "bold"), command=self.start_task)
        self.run_btn.pack(side="left", padx=10)

        self.telemetry_label = ctk.CTkLabel(self.header, text="RAM: 0% | CPU: 0% | Net: OK", text_color="#8b949e", font=("SF Mono", 12))
        ...
        self.tab_lab = self.tabview.add("Skill Lab")
        ...
        # Skill Lab Tab
        self.lab_box = ctk.CTkTextbox(self.tab_lab, fg_color="#1a1a1a", text_color="#00ffa3", font=("SF Mono", 12))
        self.lab_box.pack(fill="both", expand=True, padx=10, pady=10)
        self.lab_box.insert("end", "Skill Evolution Lab Active...\n")
    ...
    def create_card(self, parent, title, col):
        ...
        status = ctk.CTkLabel(card, text="Ready", text_color="#8b949e", wraplength=250); status.pack(pady=10)
    ...
    def _handle_event_main_thread(self, event_type, data):
        ...
        elif event_type == "skill_generated": self.lab_box.insert("end", f"\n[EVOLVED] {data}\n")
